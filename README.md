...
Добавим какую-нибудь информацию, чтобы файл в локальной папке отличался от файла на сервере 

Еще какие-то строки

Добавим какую-нибудь информацию, чтобы файл на сервере отличался от локального файла

И еще какие-то строки, для отработки навыка слияния

И смнова новая информация для обновления на сервере
